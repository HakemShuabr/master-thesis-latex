...
\begin{longtable}{|M{3cm}|M{2.5cm}|M{2cm}|M{5cm}|}
    ...
    \caption{List of the initially selected accessible data variables}
    ...
    \caption[]{List of the initially selected accessible data variables, continued}
    \\ \hline
    \textbf{Form} & \textbf{Variable Name} & \textbf{Variable Type} & \textbf{Description}
    \\ \hline                        
    \endhead
...
\begin{figure}[ht]
    ...
    \caption{The size of the data and the class distribution in the NACC UDS training and testing datasets}
