...
Following data preprocessing, feature selection, and data resampling, the subsequent section of the research methodology focuses on fine-tuning and selection of machine learning models. The main objective of this study is to develop cost-effective models capable of accurately classifying cognitive status and CI subtypes. The methodology works by employing a two-stage process as explained in the following subsections.
