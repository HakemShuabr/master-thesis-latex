...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{ENN + KMeansSMOTE} & \makecell{\textbf{0.832} \\ {\small \hl{(p = 0.026)}}} & 0.862 & \textbf{0.804} & \textbf{0.005} & \textbf{0.059} \\ \hline
    \end{tabular}
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{ENN + BorderlineSMOTE} & \makecell{\textbf{0.752} \\ {\small \hl{(p = 0.343)}}} & 0.812 & \textbf{0.697} & \textbf{0.018} & \textbf{0.158} \\ \hline
    \end{tabular}
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{ENN + KMeansSMOTE} & \makecell{\textbf{0.730} \\ {\small \hl{(p = 0.022)}}} & \textbf{0.776} & 0.688 & \textbf{0.034} & \textbf{0.161} \\ \hline
    \end{tabular}
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{ENN + KMeansSMOTE} & \makecell{\textbf{0.710} \\ {\small \hl{(p = 0.001)}}} & \textbf{0.729} & 0.692 & \textbf{0.021} & \textbf{0.125} \\ \hline
    \end{tabular}
